        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
          <div>
            ...
            <p className="text-gray-500 leading-relaxed">
              ...
              Cada missão completada é um passo real em direção a um futuro mais sustentável.
            </p>
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="border border-gray-200 rounded-xl p-6 text-center">
              ...
              <p className="text-primary text-sm font-semibold">Tech Lead</p>
              <p className="text-gray-400 text-sm">RM 571599</p>
            </div>
            <div className="border border-gray-200 rounded-xl p-6 text-center">
              <p className="font-bold text-text-main">Kauã de Deus Nunes</p>
              <p className="text-primary text-sm font-semibold">Desenvolvedor</p>
            ...
            <div className="border border-gray-200 rounded-xl p-6 text-center">
              ...
              <p className="text-primary text-sm font-semibold">QA</p>
